export default {
  ...
  account: {
    ...
    "first-name-min": "First name must have at least 1 character",
    "first-name-max": "First name cannot exceed 30 characters",
    "last-name": "Last name",
    "last-name-required": "Please enter last name",
    "last-name-min": "Last name must have at least 1 character",
    "last-name-max": "Last name cannot exceed 30 characters",
    dob: "Date of birth",
    gender: "Gender",
    "gender-male": "Male",
    "gender-female": "Female",
    "gender-other": "Other",
    "update-success": "Updated info success !",
    "update-failed": "Updated info fail !",
  ...
  address: {
    ...
    "phone-invalid":
      "Phone number must be in the form 0xxxxxxxxx or 0xx-xxx-xxxx (x from 0 to 9)",
  ...
  cart: {
    ...
    empty: "Cart is empty",
    "empty-desc": "You don't have any items in your shopping cart",
    ...
    "receive-at-store-desc":
      "Receive and experience the product at the store with the support of the staff",
    "delivery-to-home": "Home delivery",
    "delivery-to-home-desc":
  ...
  auth: {
    ...
    "reset-password-desc":
      "Please enter the email address or phone number associated with your account to verify",
    ...
    "acc-no-pass":
      "Your account has not been set a password. Set a password to help you log in to the system",
    email: "Email",
  ...
  dashboard: {
    ...
    categories: {
      ...
      "name-validation-len":
        "Category name must be between 6 and 25 characters long",
    ...
    brands: {
      ...
      "name-validation-len":
        "Brand name must be between 6 and 25 characters long",
      country: "Country",
    ...
    discounts: {
      ...
      "name-validation-len":
        "Discount name must be between 6 and 50 characters long",
      code: "Code",
      "code-validation": "Code is required",
      "code-validation-len":
        "Discount code must be between 5 and 20 characters long",
