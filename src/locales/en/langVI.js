...
export default {
  ...
  address: {
    ...
    "phone-invalid":
      "Số điện thoại phải ở dạng 0xxxxxxxxx hoặc 0xx-xxx-xxxx (x từ 0 đến 9)",
  ...
  cart: {
    ...
    "payment-method-paypal-desc":
      "Thanh toán qua PayPal an toàn và nhanh chóng",
    ...
    "payment-method-zalopay-desc":
      "Thanh toán qua ví ZaloPay an toàn và nhanh chóng",
    // receive-method
    ...
    "receive-at-store-desc":
      "Nhận và trải nghiệm sản phẩm tại cửa hàng với sự hỗ trợ của nhân viên",
  ...
  order: {
    ...
    "search-placeholder-desc":
      "Nhập mã đơn hàng hoặc số điện thoại để tìm kiếm",
    // order-status
  ...
  auth: {
    ...
    account: "Tài khoản",
    "account-tooltip":
      "Tài khoản có thể là tên đăng nhập, số điện thoại hoặc email",
    ...
    "reset-password-desc":
      "Vui lòng nhập email hoặc số điện thoại liên kết với tài khoản của bạn để xác minh",
    ...
    "acc-no-pass":
      "Tài khoản của bạn chưa được đặt mật khẩu. Đặt mật khẩu giúp bạn có thể đăng nhập vào hệ thống",
  ...
  dashboard: {
    ...
    statistics: {
      title: "Xin chúc mừng,",
      "title-detail":
        "Bán chạy nhất của tháng Bạn đã bán được nhiều hơn 57,6% hôm nay.",
