...
import Paper from "src/components/Elements/Paper";
...
const contactList = [
  ...
  },
  {
    ...
    location:
      "37 Bùi Văn Hòa, Khu phố 4, Phường Long Bình, TP Biên Hòa Đồng Nai",
    phone: "02473026867",
    mapSearch:
      "Số 11 Đại lộ Lê Lợi, P. Điện Biên, Thành phố Thanh Hóa, Thanh Hoá 40000",
  },

  {
    ...
    phone: "02473026867",
    mapSearch:
      "393 Lương Ngọc Quyến, Hàng Văn Thụ0, Thành phố Thái Nguyên, Thái Nguyên",
  },
  {
    name: "Phong Vũ Nguyễn Văn Linh",
    location:
      "16 Nguyễn Văn Linh, Phường Nam Dương, Quận Hải Châu, Thành Phố Đà Nẵng",
    phone: "02473026867",
    mapSearch:
      "Số 10 Đại lộ Lê Lợi, P. Điện Biên, Thành phố Thanh Hóa, Thanh Hoá 40000",
  },
  {
  ...
  },
  {
    ...
    phone: "02473026867",
    mapSearch:
      "391 Lương Ngọc Quyến, Hàng Văn Thụ0, Thành phố Thái Nguyên, Thái Nguyên",
  },
  {
    ...
    phone: "02473026867",
    mapSearch:
      "Số 9 Đại lộ Lê Lợi, P. Điện Biên, Thành phố Thanh Hóa, Thanh Hoá 4000",
  },
];
...
const ContactLocationDialog = forwardRef<HTMLDivElement, Props>(
  (props, ref) => {
    const { onClose } = props;
                ...
                <ul className="list">
                  {contactList.map((contact, index) => (
                    <li
                      key={index}
                      className={
                        contact.mapSearch === map ? "item active" : "item"
                      }
